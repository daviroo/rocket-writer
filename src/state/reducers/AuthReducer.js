import { SHOW_LOGIN_SCREEN, HIDE_LOGIN_SCREEN, LOGIN_SUCCESS, LOGOUT_SUCCESS, LOGOUT, LOGOUT_FAILED, AUTHENTICATION_FAILED, UPDATE_ACCOUNT_ID } from "../actions/AuthActions";
const initialState = {
