import { SHOW_LOGIN_SCREEN, HIDE_LOGIN_SCREEN, LOGIN_SUCCESS, LOGOUT_SUCCESS, LOGOUT, LOGOUT_FAILED, AUTHENTICATION_FAILED, UPDATE_ACCOUNT_ID, SET_ANIMATION_FINISHED, RESET_AUTH_STATE } from "../actions/AuthActions";
const initialState = {
